<template>
  <div class="dashboardWrapper">
    <div class="title">后台统计数据</div>
    <div class="nav">
      <router-link to="/admin/transfer">
      ...
      <router-link to="/admin/share">
        <a-button>分享任务系统</a-button>
      </router-link>

      <router-link to="/admin/whitelist">
        <a-button>白名单管理</a-button>
      </router-link>
    </div>
    ...
    <div class="contentWrapper">
      ...
      <div class="participation">
        <div class="cardTitle">发放游戏奖励</div>
        <div class="peopleNum">
      ...
      <div class="participation">
        <div class="cardTitle">发放分享奖励</div>
        <div class="peopleNum">
      ...
      <div class="participation">
        <div class="cardTitle">单人奖励Max</div>
        <!--<div class="peopleNum">-->
      ...
      <div class="participation">
        <div class="cardTitle">单人奖励Min</div>
        <!--<div class="peopleNum">-->
  ...
  methods: {
    getHourly() {
      fetch("/api/v1/stats/yield/hourly?page=0&size=48", {
        ...
        this.annuallyRate =
          (result.data.items[0].annually_rate * 100).toFixed(2) + "%";
    ...
    getTotalNum() {
      fetch("/api/v1/stats/total", {
        ...
        this.single_reward_max = result.data.single_reward_max
          ? result.data.single_reward_max
          : 0;
        this.single_reward_min = result.data.single_reward_min
          ? result.data.single_reward_min
          : 0;
      });
    },
    getHistoryList() {
    ...
    awardsHasBeenOpen() {
      const awardsHasBeenOpenBarDom =
        document.getElementById("awardsHasBeenOpen");
