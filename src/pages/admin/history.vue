  ...
  <div class="wrapper">
    ...
    <div class="header">
      <div class="headerButton">
        ...
        <div
          :class="['btnItem', selectBtnIndex === 1 ? 'selectBtn' : '']"
...
export default {
  ...
  methods: {
    ...
    getWithdrawHistory(pageIndex = 0) {
      fetch(
        `/api/v1/withdraw/histories?address=${this.searchValue}&page=${pageIndex}&size=10`,
        {
          method: "GET",
          mode: "cors",
        }
